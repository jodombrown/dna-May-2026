    ...
    <div className={cn('w-full', className)}>
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2 pr-12">
          ...
          >
            <FuntunfunefuDenkyemfunefu className="w-3 h-3" style={{ color: ACCENT }} />
          </div>
          <span
        ...
        <div className="flex items-start gap-2 mb-1.5">
          ...
          <h4 className="font-semibold text-sm text-foreground leading-tight">
            DIA is preparing your COLLABORATE intelligence
          </h4>
        </div>

        <p className="text-sm text-muted-foreground leading-relaxed ml-6">
          Spaces are being reimagined. Your DIA insights will return with the new module.
        </p>
