...
BEGIN
  ...
  v_is_owner := (p_viewer_id = v_profile.id);
  ...
  v_result := json_build_object(
    'profile', ((to_jsonb(v_profile) - 'email')::json),
    'tags', '{}'::json,
    'activity', v_activity,
    ...
    'completion', json_build_object('score', 0, 'suggested_actions', '[]'::json),
    'verification_meta', '{}'::json,
    'connection_status', v_connection_status,
    'should_show_public_landing', false,
    'is_owner', v_is_owner
  );
